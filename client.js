window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = [
			...
			".dshm-body{padding:10px 12px 12px}",
			...
			".dshm-list{max-height:168px;overflow-y:auto;overflow-x:hidden;margin-top:8px;padding-top:5px;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,0.25) transparent}",
