...
边聊边听歌：给 [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) Web 加一个 APlayer 风格的悬浮音乐播放器。

A floating APlayer-style music player for DeepSeek Harness Web — chat and listen at the same time.
